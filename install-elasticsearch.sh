...
path.logs: /home/logs/xeslog/elasticsearch
...
path.repo: ["/elasticsearch/snapshort-back"]
...
EOF
mkdir -p /elasticsearch/snapshort-back
...
-XX:HeapDumpPath=/home/logs/elasticsearch
-XX:ErrorFile=/home/logs//elasticsearch/hs_err_pid%p.log
## JDK 8 GC logging
8:-XX:+PrintGCDetails
8:-XX:+PrintGCDateStamps
8:-XX:+PrintTenuringDistribution
8:-XX:+PrintGCApplicationStoppedTime
8:-Xloggc:/home/logs/elasticsearch/gc.log
8:-XX:+UseGCLogFileRotation
8:-XX:NumberOfGCLogFiles=32
8:-XX:GCLogFileSize=64m
# JDK 9+ GC logging
9-:-Xlog:gc*,gc+age=trace,safepoint:file=/home/logs/elasticsearch/gc.log:utctime,pid,tags:filecount=32,filesize=64m
